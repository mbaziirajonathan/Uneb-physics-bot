...
# ============ 3. PYTHON SVG DRAW ENGINE - 30 TEMPLATES V3.5.0 ============
def svg_header(title):
    return f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
    <defs><marker id="arrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto"><path d="M 0 1.5 L 8 5 L 0 8.5 z" fill="black"/></marker></defs>
    <text x="400" y="40" text-anchor="middle" font-family="Arial" font-size="18" font-weight="bold">{title}</text>'''
...
# PHYSICS
def draw_convex_lens(): return svg_header("Convex Lens Ray Diagram - S3 Physics") + '<ellipse cx="400" cy="300" rx="15" ry="120" fill="#e1f5fe" stroke="black" stroke-width="2"/><circle cx="300" cy="300" r="5" fill="black"/><text x="310" y="290">F</text><circle cx="500" cy="300" r="5" fill="black"/><text x="510" y="290">F</text><rect x="150" y="350" width="20" height="80" fill="black"/><text x="140" y="450">Object</text>' + svg_footer()
def draw_simple_circuit(): return svg_header("Simple Circuit - S2 Physics") + '<rect x="150" y="270" width="40" height="60" fill="none" stroke="black" stroke-width="3"/><text x="170" y="350" text-anchor="middle">Cell</text><circle cx="650" cy="300" r="30" fill="none" stroke="black" stroke-width="2"/><text x="650" y="305" text-anchor="middle">Bulb</text><rect x="380" y="120" width="40" height="20" fill="gray"/><text x="400" y="110" text-anchor="middle">Switch</text><line x1="190" y1="300" x2="380" y2="130" stroke="black" stroke-width="2"/><line x1="420" y1="130" x2="620" y2="300" stroke="black" stroke-width="2"/><line x1="680" y1="300" x2="680" y2="400" x2="190" y2="400" x2="190" y2="330" stroke="black" stroke-width="2"/>' + svg_footer()
...
# BIOLOGY
def draw_plant_cell(): return svg_header("Plant Cell - S1 Biology") + '<rect x="200" y="150" width="400" height="300" fill="#dcedc8" stroke="black" stroke-width="2"/><text x="610" y="160">Cell Wall</text><rect x="205" y="155" width="390" height="290" fill="none" stroke="green" stroke-width="1.5"/><text x="610" y="180">Cell Membrane</text><circle cx="300" cy="300" r="40" fill="#ffcdd2" stroke="black"/><text x="250" y="300">Nucleus</text><circle cx="450" cy="300" r="90" fill="#e1f5fe" stroke="black"/><text x="560" y="300">Vacuole</text><rect x="220" y="180" width="25" height="12" fill="#2e7d32"/><text x="180" y="185">Chloroplast</text>' + svg_footer()
def draw_animal_cell(): return svg_header("Animal Cell - S1 Biology") + '<circle cx="400" cy="300" r="150" fill="#e1f5fe" stroke="black" stroke-width="2"/><text x="570" y="300">Cell Membrane</text><circle cx="400" cy="300" r="40" fill="#ffcdd2" stroke="black"/><text x="250" y="300">Nucleus</text><rect x="480" y="250" width="35" height="15" rx="5" fill="#ff8a65"/><text x="520" y="260">Mitochondria</text>' + svg_footer()
...
# GEOGRAPHY
def draw_water_cycle(): return svg_header("Water Cycle - S1 Geography") + '<circle cx="700" cy="100" r="30" fill="#fff176" stroke="black"/><text x="700" y="150" text-anchor="middle">Sun</text><ellipse cx="400" cy="100" rx="50" ry="30" fill="white" stroke="black"/><text x="400" y="150" text-anchor="middle">Cloud</text><rect x="100" y="350" width="600" height="80" fill="#64b5f6" stroke="black"/><text x="400" y="400" text-anchor="middle">Ocean</text><line x1="400" y1="130" x2="400" y2="350" stroke="blue" stroke-dasharray="4,4" marker-end="url(#arrow)"/>' + svg_footer()
def draw_carbon_cycle(): return svg_header("Carbon Cycle - S2 Geography") + '<rect x="340" y="80" width="120" height="50" fill="#bbdefb" stroke="black"/><text x="400" y="110" text-anchor="middle">Atmosphere</text><rect x="140" y="300" width="100" height="50" fill="#a5d6a7" stroke="black"/><text x="190" y="330" text-anchor="middle">Plants</text><rect x="340" y="300" width="100" height="50" fill="#ffccbc" stroke="black"/><text x="390" y="330" text-anchor="middle">Animals</text><line x1="340" y1="105" x2="240" y2="300" stroke="black" marker-end="url(#arrow)"/>' + svg_footer()

# CHEMISTRY
def draw_water_molecule(): return svg_header("Water Molecule H2O - S2 Chemistry") + '<circle cx="400" cy="300" r="30" fill="#f44336" stroke="black"/><text x="400" y="305" text-anchor="middle" fill="white">O</text><circle cx="350" cy="250" r="20" fill="#90caf9" stroke="black"/><text x="350" y="255" text-anchor="middle" fill="white">H</text><circle cx="450" cy="250" r="20" fill="#90caf9" stroke="black"/><text x="450" y="255" text-anchor="middle" fill="white">H</text><line x1="380" y1="280" x2="360" y2="260" stroke="black" stroke-width="2"/><line x1="420" y1="280" x2="440" y2="260" stroke="black" stroke-width="2"/>' + svg_footer()
def draw_atom(): return svg_header("Atom Structure - S3 Chemistry") + '<circle cx="400" cy="300" r="25" fill="#ef5350" stroke="black"/><text x="400" y="305" text-anchor="middle" fill="white">Nucleus</text><circle cx="400" cy="300" r="80" fill="none" stroke="gray" stroke-dasharray="4,4"/><circle cx="400" cy="300" r="120" fill="none" stroke="gray" stroke-dasharray="4,4"/><circle cx="480" cy="300" r="8" fill="#42a5f5"/><circle cx="320" cy="300" r="8" fill="#42a5f5"/>' + svg_footer()
def draw_filtration(): return svg_header("Filtration Apparatus - S1 Chemistry") + '<polygon points="350,200 450,200 400,300" fill="none" stroke="black" stroke-width="2"/><text x="400" y="180" text-anchor="middle">Funnel</text><rect x="350" y="320" width="100" height="80" fill="none" stroke="black" stroke-width="2"/><text x="400" y="420" text-anchor="middle">Beaker</text><rect x="370" y="290" width="60" height="20" fill="#bdbdbd"/><text x="400" y="285" text-anchor="middle">Residue</text>' + svg_footer()

# AGRICULTURE
def draw_soil_profile(): return svg_header("Soil Profile - S2 Agriculture") + '<rect x="250" y="150" width="300" height="60" fill="#8d6e63" stroke="black"/><text x="560" y="180">Topsoil</text><rect x="250" y="220" width="300" height="80" fill="#a1887f" stroke="black"/><text x="560" y="260">Subsoil</text><rect x="250" y="310" width="300" height="60" fill="#bdbd" stroke="black"/><text x="560" y="340">Parent Rock</text>' + svg_footer()
def draw_irrigation(): return svg_header("Drip Irrigation - S4 Agriculture") + '<rect x="100" y="200" width="80" height="60" fill="#90caf9" stroke="black"/><text x="140" y="235" text-anchor="middle">Tank</text><rect x="200" y="225" width="300" height="10" fill="#42a5f5"/><circle cx="550" cy="230" r="15" fill="#66bb6a"/><text x="580" y="235">Crop</text>' + svg_footer()
...
def draw_crop_rotation(): return svg_header("4 Year Crop Rotation - S3 Agric") + '<rect x="200" y="200" width="120" height="60" fill="#a5d6a7" stroke="black"/><text x="260" y="235" text-anchor="middle">Legumes</text>' + svg_footer()
def draw_digestive_cow(): return svg_header("Ruminant Digestive System - S3 Agric") + '<circle cx="300" cy="300" r="50" fill="#bcaaa4" stroke="black"/><text x="300" y="305" text-anchor="middle">Rumen</text>' + svg_footer()
def draw_refraction(): return svg_header("Refraction Through Prism - S3 Physics") + '<polygon points="400,150 300,450 500,450" fill="none" stroke="black" stroke-width="2"/><text x="400" y="470" text-anchor="middle">Triangular Prism</text>' + svg_footer()

PYTHON_DRAW_ENGINE = {
    "cone": draw_cone, "cylinder": draw_cylinder, "sphere": draw_sphere, "triangle": draw_triangle, "bar graph": draw_bar_graph, "pie chart": draw_pie_chart, "prism": draw_prism,
    "convex lens": draw_convex_lens, "circuit": draw_simple_circuit, "pendulum": draw_simple_pendulum,
    "plant cell": draw_plant_cell, "animal cell": draw_animal_cell, "heart": draw_human_heart,
    "water cycle": draw_water_cycle, "carbon cycle": draw_carbon_cycle,
    "water molecule": draw_water_molecule, "atom": draw_atom, "filtration": draw_filtration,
    "soil profile": draw_soil_profile, "irrigation": draw_irrigation, "crop rotation": draw_crop_rotation, "digestive": draw_digestive_cow,
    "cartesian": draw_cartesian, "circle": draw_circle_parts, "refraction": draw_refraction
}

 # ============ 4. MASTER SYSTEM PROMPT ============
MASTER_SYSTEM_PROMPT = """
You are DIGITAL UNEB TUTOR 2026 PRO. Senior NCDC UNEB Examiner for Uganda S1-S6.
For questions use ITEM/TASK/SCENARIO. For math show Given, Formula, Substitution, Answer.
"""
