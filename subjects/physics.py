...
PHYSICS_CONTENT: Dict[tuple[str, str], Dict[str, Any]] = {
    ...
    ("S1", "Measurement"): {"text": "### Measurement\n**SI Units:** Length=m, Mass=kg, Time=s. **Instruments:** Ruler, Vernier calipers, Stopwatch.", "diagram": None},
    ("S1", "Force"): {"text": "### Force\nA push or pull. **Types:** Gravitational, Frictional, Magnetic. **Unit:** Newton. $F=ma$", "diagram": None},
    ...
    ("S2", "Current Electricity"): {"text": "### Current Electricity\nFlow of electrons. **Laws:** Ohm's Law $V=IR$. **Components:** Battery, Resistor, Ammeter.", "diagram": None},
    ...
    ("S2", "Waves"): {"text": "### Waves\nDisturbance that transfers energy. **Types:** Transverse, Longitudinal. $v = f \\lambda$", "diagram": "assets/wave.png"},

    # SENIOR 3
    ("S3", "Hookes Law"): {"text": "### Hooke's Law\nExtension is proportional to force. $F = ke$", "diagram": "assets/hookes_law.png"},
    ("S3", "Specific Heat Capacity"): {"text": "### Specific Heat Capacity\nHeat to raise 1kg by 1°C. $Q = mc\\theta$", "diagram": "assets/specific_heat.png"},
    ("S3", "Magnetism"): {"text": "### Magnetism\nProperties of magnets. **Poles:** Like repel, unlike attract. **Earth's magnetic field.**", "diagram": None},
    ...
    ("S4", "Electronics"): {"text": "### Electronics\nStudy of diodes, transistors. **Applications:** Rectification, Amplification.", "diagram": None},
    ("S4", "Nuclear Physics"): {"text": "### Nuclear Physics\n**Fission:** Splitting nucleus. **Fusion:** Joining nuclei. Used in power and bombs.", "diagram": None},
    ("S4", "Astrophysics"): {"text": "### Astrophysics\nStudy of celestial bodies. **Topics:** Stars, Galaxies, Big Bang Theory.", "diagram": None},
}
