...
UNEB_CURRICULUM_MAP: Dict[str, Dict[str, Dict[str, str]]] = {
    "Biology": {
        ...
        "S2": {
            "Plant Nutrition - Transverse Section of Leaf": "leaf_ts",
            "Human Anatomy - Alveolus": "alveolus"
        },
        "S3": {
            "Transport in Humans - Heart Structure": "heart",
            "Excretion - Kidney Nephron": "nephron"
        },
        "S4": {
            "Coordination - Motor Neurone": "neurone"
        }
    },
    "Chemistry": {
        "S1": {
            "Atomic Structure": "atom",
            "Separation Techniques - Filtration": "filtration",
            "Separation Techniques - Chromatography": "chromatography"
        },
        "S2": {
            "Bonding - Covalent Water Molecule": "covalent_water",
            "Oxygen Preparation": "gas_prep"
        },
        "S3": {
            "Moles & Volumetric Analysis - Titration Setup": "titration"
        },
        "S4": {
            "Organic Chemistry - Fractional Distillation": "fractional_distillation"
        }
    }
}
